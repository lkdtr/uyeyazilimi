...
<input type="radio" name="a_x_StatikSayfa" value="1" checked>Olduðu gibi býrak&nbsp;<input type="radio" name="a_x_StatikSayfa" value="2">Çýkar&nbsp;<input type="radio" name="a_x_StatikSayfa" value="3">Deðiþtir<br>
<?php } else { ?>
