...
<input type="radio" name="x_cinsiyet"<?php if ($x_cinsiyet == "m") { echo " checked"; } ?> value="<?php echo htmlspecialchars("m"); ?>">Kadýn
&nbsp;</td>
</tr>
<tr>
...
<tr>
 ...
 <td bgcolor="#F5F5F5"><input type="text" name="x_Uye_karar_tarih" value="<?php echo @$x_Uye_karar_tarih ?>" size=30 maxlength=100>&nbsp;<small>(Yýl-Ay-Gün)</small></td>
</tr>
...
<tr>
 ...
 <input type="radio" name="x_kimlik_basildi" checked value=0>Hayýr&nbsp;
</tr>
...
<tr>
 ...
 <input type="radio" name="x_kimlik_iletildi" checked value=0>Hayýr&nbsp;
</tr>
