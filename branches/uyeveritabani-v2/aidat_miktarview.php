...
if (($ewCurSec & ewAllowview) <> ewAllowview) header("Location: aidat_miktarlist.php");
?>
<?php
...
<td bgcolor="#F5F5F5"><?php echo $x_aidat_id; ?>&nbsp;</td>
</tr>
<tr>
<td bgcolor="#466176"><font color="#FFFFFF">yil&nbsp;</td>
<td bgcolor="#F5F5F5"><?php echo $x_yil; ?>&nbsp;</td>
</tr>
<tr>
<td bgcolor="#466176"><font color="#FFFFFF">miktar&nbsp;</td>
<td bgcolor="#F5F5F5"><div align="right"><b><?php echo (is_numeric($x_miktar)) ? FormatCurrency($x_miktar,0,-2,-2,-2) : $x_miktar; ?></b></div>&nbsp;</td>
</tr>
</table>
</form>
<p>
