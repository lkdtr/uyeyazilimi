...
<b>Üye Bilgilerinizin Güncellenmesi Gerekmektedir.</b> Yeni Üye Veritabaný Programýmýza üye bilgilerinin güncellenmesi için yardýmýnýza ihtiyacýmýz var. <img src="images/edit.gif" align="absmiddle"> simgesine týklayarak bilgilerinizi güncelleyebilirsiniz.
<br>
<b>Aidat Ödemeleri ile ilgili...</b> Üye kayýt tarihleri (Derneðe üye olduðunuz tarih) ve ödeme bilgileriniz güncelleninceye kadar epey borçlu görünebilirsiniz. Bu konuda da yardýma ihtiyacýmýz var, veri giriþi konusunda çalýþabilecek gönüllü arkadaþlarýmýzýn web-cg@linux.org.tr adresine mail atmalari yeterli olacaktýr.</td></tr></table>*/?>
<br>
...
<table border="0" cellspacing="0" cellpadding="4">
	<tr>
		...
		<td>
			...
			&nbsp;&nbsp;<a href="uyelersrch.php">Detaylý Arama</a>
		</td>
		<?php
...
?>
	Burayi Gormeye Ýzniniz Yok! Bir hata oldugunu dusunuyorsaniz bilgi@lkd.org.tr adresine mail atiniz.
<?php
	}
?>
<p>
