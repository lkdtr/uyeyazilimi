...
<?php } ?>
<tr><td colspan=2>
Parolanýz e-posta adresinize gönderilecektir.</td></tr>
...
<?php } else {
	...
	$content = "Sayýn $row[0] $row[1],\r\n\r\n";
//	$content .= "Bu e-posta, Linux Kullanýcýlarý Derneði Üye Veritabaný için yeni bir parola istediðiniz için gönderilmiþtir. Eðer kendiniz böyle bir istekte bulunmadýysanýz, mesajý dikkate almayabilirsiniz.\r\n\r\n";
	$content .= "Bu e-posta, Linux Kullanýcýlarý Derneði Üye Veritabaný için yeni bir parola istediðiniz için gönderilmiþtir. Eðer kendiniz böyle bir istekte bulunmadýysanýz, lütfen yeni parolanýzý kaydediniz..\r\n\r\n";
	$content .= "Yeni Parolanýz : $rndPass\r\n\r\n";
	//$content .= "Parolanýz : $row[3]\r\n\r\n";
	$content .= "Parolanýzý sisteme giriþ yaptýktan sonra deðiþtirebilirsiniz.\r\n\r\n";
	$content .= "Üyelikle ilgili her türlü sorununuz için uye@lkd.org.tr adresi ile baðlantý kurabilirsiniz.";

	$headers = "From: LKD Uyelik Sistemi <uye@lkd.org.tr>\r\nContent-type: text/plain; charset=ISO-8859-9";
	$to = "$row[2]";
	if(time() > $_SESSION["Sifre_Mail_Time"]+(5*60) || 1) {
		echo "<br>Mailiniz Gönderilmiþtir. Teþekkür Ederiz.";
