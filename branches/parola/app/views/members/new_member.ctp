...
<?php
	...
	echo $form->input('lotr_alias',array('label'=>"ad.soyad@linux.org.tr biçimindeki LKD e-posta adresinizin sadece <strong>ad.soyad</strong> kısmını giriniz.",'after'=>'@linux.org.tr'));     
