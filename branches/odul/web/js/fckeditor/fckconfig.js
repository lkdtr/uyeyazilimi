...
//FCKConfig.EditorAreaCSS = FCKConfig.BasePath + '../css/core.css' ;
...
FCKConfig.ToolbarSets["Default"] = [
	['Bold','Italic','Underline','TextColor','-','OrderedList','UnorderedList','-','About'],
] ;
...
FCKConfig.ToolbarSets["Admin"] = [
	['Source','Preview'],
	['Cut','Copy','Paste','-','Undo','Redo','-','Find','RemoveFormat'],
	['Link','Unlink','Anchor'],
