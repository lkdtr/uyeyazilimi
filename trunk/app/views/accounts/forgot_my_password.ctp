...
<p>Eğer ilk defa üye sistemine giriş yapmak istiyorsanız ve ilk defa parola alacaksanız <?php echo $html->link('bu sayfayı kullanınız',array('controller'=>'accounts','action'=>'new_account')) ?>.</p>
<?php
	echo $form->create('Account', array('action' => 'forgot_my_password'));     
