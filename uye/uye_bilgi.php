...
<html>
 ...
 <body bgcolor="#d6dde7">
  ...
  <p><a href="javascript:toggleLayer('edit')">Bilgi/Parola Değiştir</a> - <a href="javascript:toggleLayer('OdemeDetaylari')">Aidat Ödeme Detaylarınız</a> - <a href="javascript:toggle('Davet','foto')">Arkadaşını Derneğe Davet Et</a></p>
...
?>
       <tr bgcolor="#F5F5F5">
        ...
        <td>
         <?php
          echo $aidat_miktar['miktar'] . ' TL';
          if($aidat_odemesi < $aidat_miktar['miktar'])
           if($aidat_odemesi > 0)
            echo " (Kısmi Ödendi)";
           else
            echo " (Ödendi)";
          $aidat_odemesi -= $aidat_miktar['miktar'];
         ?>
        </td>
       </tr>
<?php
...
?>
       <tr bgcolor="#F5F5F5">
        ...
        <td>5 TL<?php if($aidat_odemesi <= 0) echo " (Ödendi)"; ?></td>
       </tr>
<?php
      }
?>
  ...
  <div id="foto" style="display: block">
   <p>&nbsp;</p>
   <p>&nbsp;</p>
   <?php
    ...
    <table>
      ...
      <tbody>
        <tr>
          ...
          <td bgcolor="#F5F5F5"><input type="text" size="25" name="adi"></td>
        </tr>
        <tr>
          <td bgcolor="#466176"><font color="#FFFFFF">E-Posta Adresi</font></td>
          <td bgcolor="#F5F5F5"><input type="text" size="25" name="eposta"></td>
        </tr>
        <tr>
