...
$uyeGuncelle='UPDATE uyeler SET eposta1 = "' . mysql_real_escape_string(@strip_tags($_POST['txt_mail1'])) . '",
                          ...
                          is_addr = "' . mysql_real_escape_string(@strip_tags($_POST['txt_is_addr'])) .'",
                          TCKimlikNo = "' . mysql_real_escape_string(@strip_tags($_POST['txt_TCKimlikNo'])) .'",
                          kimlik_durumu = "' . mysql_real_escape_string(@strip_tags($_POST['txt_kimlik_durumu'])) .'",
