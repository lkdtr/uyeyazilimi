...
if (($ewCurSec & ewAllowdelete) <> ewAllowdelete) header("Location: yoneticilerlist.php");
?>
<?php
...
{
	case "I": // display
		$strsql = "SELECT * FROM yoneticiler WHERE " . $sqlKey;
		...
		break;
	case "D": // delete
		$strsql = "DELETE FROM yoneticiler WHERE " . $sqlKey;
...
<tr bgcolor="#466176">
<td><font color="#FFFFFF">Admin Ad&nbsp;</td>
<td><font color="#FFFFFF">Admin Pass&nbsp;</td>
<td><font color="#FFFFFF">Admin Mail&nbsp;</td>
</tr>
<?php
$recCount = 0;
